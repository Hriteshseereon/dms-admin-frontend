  ...
  return (
    <div>
      ...
      <div className="border border-amber-300 rounded-lg p-4 shadow-md">
        <h2 className="text-lg font-semibold text-amber-700 mb-0">Gold / Lot Transactions</h2>
        <p className="text-amber-600 mb-3">Record purchases, interest and transfers for gold lots</p>
